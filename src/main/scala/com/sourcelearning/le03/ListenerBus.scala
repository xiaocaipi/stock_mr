 ...
 */
private[le03] trait ListenerBus[L <: AnyRef, E] extends Logging {

  // Marked `private[spark]` for access in tests.
  private[le03] val listeners = new CopyOnWriteArrayList[L]
  ...
  private[le03] def findListenersByClass[T <: L : ClassTag](): Seq[T] = {
