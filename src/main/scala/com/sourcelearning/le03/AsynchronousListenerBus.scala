 ...
 */
//le03 是作用域的问题  说明这个类只能在这个le03包 下访问
private[le03] abstract class AsynchronousListenerBus[L <: AnyRef, E](name: String)extends ListenerBus[L, E]
  {
  ...
  private val eventLock = new Semaphore(1)
